...
//            String line;
//            // Saltar a primeira linha (cabeçalho)
//            reader.readLine();
//
...
//    public static List<ChargerData> readChargerDataExcel(String excelFilePath) {
//        List<ChargerData> dataList = new ArrayList<>();
//
...
//
//
//            Sheet sheet = workbook.getSheetAt(0); // Assume que a primeira folha contém os dados
//
//            // Saltar a primeira linha (cabeçalho)
...
//                String supercharger = currentRow.getCell(0).getStringCellValue();
//                String streetAddress = currentRow.getCell(1).getStringCellValue();
//                String city = currentRow.getCell(2).getStringCellValue();
//                String state = currentRow.getCell(3).getStringCellValue();
//                String zip = currentRow.getCell(4).getStringCellValue();
//                String country = currentRow.getCell(5).getStringCellValue();
//                int stalls = (int) currentRow.getCell(6).getNumericCellValue();
//                int kW = (int) currentRow.getCell(7).getNumericCellValue();
//                String gps = currentRow.getCell(8).getStringCellValue();
//                String elevm = currentRow.getCell(9).getStringCellValue();
//                String status = currentRow.getCell(10).getStringCellValue();
//
//                dataList.add(new ChargerData(supercharger, streetAddress, city, state, zip, country, stalls, kW, gps, elevm, status));
//            }
//        } catch (IOException e) {
